        ...
        async () =>
          this.globalWorkspaceOrmManager.runInWorkspaceTransaction(
            async (transactionScope) => {
                ...
                fetchedCalendarEventsWithDBEvents.map(
                  ({ fetchedCalendarEvent, existingCalendarEvent }) => {
                    const savedCalendarEventId =
                      newCalendarEventIdByExternalId.get(
                        fetchedCalendarEvent.id,
                      );
                      ...
                      partialEntity: {
                        ...
                        conferenceLink: {
                          primaryLinkLabel:
                            fetchedCalendarEvent.conferenceLinkLabel,
                          primaryLinkUrl:
                            fetchedCalendarEvent.conferenceLinkUrl,
                          secondaryLinks: [],
                        },
                        externalCreatedAt:
                          fetchedCalendarEvent.externalCreatedAt,
                        externalUpdatedAt:
                          fetchedCalendarEvent.externalUpdatedAt,
                      },
                    };
                  });
              ...
              return this.calendarEventParticipantService.upsertAndDeleteCalendarEventParticipants(
                {
